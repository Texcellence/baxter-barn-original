	...
	<body>
		...
		<form action="?<?php htmlout($action); ?>" method="post">
			<div>
				...
				<textarea id="text" name="text" rows="2" cols="40"><?php
			...
			<fieldset>
				...
				<textarea id="location" name="location" rows="1" cols="40"><?php
						htmlout($location); ?></textarea>
			</div>
			<div><label for="wage">Hourly Wage:</label>
				<select id="wage" name="wage" rows="2" cols="40">
				<option>$0-5</option>
				<option>$5-10</option>
				<option>$10-15</option>
				<option>$15-20</option>
